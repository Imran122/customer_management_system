    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categorey', models.CharField(choices=[('Indoor', 'Indoor'), ('Out Door', 'Out Door')], max_length=200, null=True)),
                ('feature', models.CharField(choices=[('new', 'new'), ('sold', 'sold'), ('offer', 'offer')], max_length=200, null=True)),
